...
def main(data_filename1,data_filename2,hist_filename1,hist_filename2):
    """ 
    ...
    * obs_hist_filename1,obs_hist_filename2
    ...
    myregion=[141.0,-29.0,159.0,-11.0]
...
def plot_histogram_maps(hist_filename1,hist_filename2,runtitle,plotname_root):
    ...
    plot_hist_maps.plot_rain_contr(avg_rain_bins_a,avg_rain_bins_b,plotname,
                  runtitle,'Timescale 1','Timescale 2',all_ppn_bounds,region=[140.0,-30.0,160.0,-10.0])    
...
if __name__ == '__main__':
    ...
    main(args.data_one,args.data_two,args.hist_one,args.hist_two)
